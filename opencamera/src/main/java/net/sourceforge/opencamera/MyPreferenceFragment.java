        ...
        }*/
        {
        	...
        	pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
            		...
            		OpenCameraActivity main_activity = (OpenCameraActivity)MyPreferenceFragment.this.getActivity();
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_donate") ) {
            	        ...
            	        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(OpenCameraActivity.getDonateLink()));
        	        	startActivity(browserIntent);
                		return false;
                	}
                	return false;
